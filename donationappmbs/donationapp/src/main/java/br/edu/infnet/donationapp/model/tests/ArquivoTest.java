		...
		try {
			...
			try {
				...
				while (linha != null) {
					...
					case "A":
						try {
							Alimento alimento = new Alimento(campos[1], campos[2], Float.valueOf(campos[3]), campos[5]);
							alimento.setPerecivel(Boolean.valueOf(campos[4]));
							alimento.setMeses(Integer.valueOf(campos[6]));
					...
					case "M":
						try {
							Movel movel = new Movel(campos[1], campos[2], Float.valueOf(campos[3]), campos[5]);
					...
					case "V":
						try {
							Vestuario vestuario = new Vestuario(campos[1], campos[2], Float.valueOf(campos[3]),
									campos[5]);
							vestuario.setNova(Boolean.valueOf(campos[4]));
