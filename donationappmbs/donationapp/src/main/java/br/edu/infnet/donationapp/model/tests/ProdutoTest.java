...
public class ProdutoTest {
	...
	public static void main(String[] args) {
		...
		try {
			Alimento a1 = new Alimento("15", "sanduíche", 6, "McDonalds");
		...
		try {
			Alimento a2 = new Alimento("20", "macarrão", 10, "DaMamma");
		...
		try {
			Alimento a3 = new Alimento("21", "suco", 8, "Polpuddo");
		...
		try {
			Movel m1 = new Movel("30", "colchão", 109, "Probel");
			m1.setUsado(true);
			m1.setTamanho(202);
		...
		try {
			Vestuario v1 = new Vestuario("35", "blusa", 1200, "Gucci");
			v1.setNova(true);
			v1.setTamanho(44);
