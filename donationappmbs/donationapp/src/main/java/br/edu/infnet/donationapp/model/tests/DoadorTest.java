...
public class DoadorTest {
	...
	public static void main(String[] args) {
		...
		try {
			Doador s1 = new Doador("mariana", "1000000000", "mahbs@hotmail.com");
		...
		try {
			Doador s2 = new Doador(null, "999999", "ma@bu.com");
		...
		try {
			Doador s3 = new Doador("jack", null, "jack@strip.com");
		...
		try {
			Doador s3 = new Doador("creep", "6666666", null);
			System.out.println(s3);
		} catch (DoadorInvalidoException e) {
			System.out.println("[ERRO] " + e.getMessage());
		}
